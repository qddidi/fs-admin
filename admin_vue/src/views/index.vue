<template>
  <div class="p-[20px]">
    ...
    <div>
      ...
      <img src="https://github.com/qddidi/fs-admin/blob/develop/assets/01.jpg?raw=true" alt="登录页面" class="w-2/3" />
      ...
      <img
        src="https://p9-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/35c60613326c4746a65137e4fb39ab0a~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg5Lic5pa55bCP5pyI:q75.awebp?rk3s=f64ab15b&x-expires=1736480334&x-signature=kyeerLbg8eqns5OrYkrokTNc7oY%3D"
        alt="菜单管理页面" class="w-2/3" />
      <h4 class="text-xl font-bold mb-10 mt-10">用户管理页面</h4>
      <img
        src="https://p9-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/4c996d8d02a745ad9bf18cf6905e7b0d~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg5Lic5pa55bCP5pyI:q75.awebp?rk3s=f64ab15b&x-expires=1736480334&x-signature=u4%2BqK9JbJE2PL%2BKukOqk4nfd%2Bp4%3D"
        alt="用户管理页面" class="w-2/3" />
      <h4 class="text-xl font-bold mb-10 mt-10">日志管理</h4>
      <img
        src="https://p9-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/e0400b4b01404eef9148b41100032add~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg5Lic5pa55bCP5pyI:q75.awebp?rk3s=f64ab15b&x-expires=1736480334&x-signature=J1IyqiwkGTT0fvV%2BJ2qbDifQMh4%3D"
        alt="日志管理" class="w-2/3" />
      <h4 class="text-xl font-bold mb-10 mt-10">个人中心</h4>
      <img
        src="https://p9-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/b9b39b13ed334d1ba5772924e1accd69~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg5Lic5pa55bCP5pyI:q75.awebp?rk3s=f64ab15b&x-expires=1736480334&x-signature=WTdKo7z1VpN5skYDbsIEGQN673g%3D"
